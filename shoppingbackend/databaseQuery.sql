...
VALUES ('Abhishek', 'Kaushal', 'ADMIN', true, 'admin', 'ak@gmail.com', '8888888888');

INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Manisha', 'Rawat', 'SUPPLIER', true, '12345', 'mr@gmail.com', '9999999999');

INSERT INTO user_detail 
(first_name, last_name, role, enabled, password, email, contact_number) 
VALUES ('Shubham', 'Mittal', 'SUPPLIER', true, '12345', 'sm@gmail.com', '7777777777');
